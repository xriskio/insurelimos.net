...
import { Shield, CheckCircle, Phone, Clock, Award, Heart } from "lucide-react";
import { motion } from "framer-motion";
import heroImage from "@assets/generated_images/ford_transit_wheelchair_ramp_van.png";
...
export default function NemtLanding() {
    ...
    try {
      const response = await fetch("/api/quotes/transport", {
        ...
        body: JSON.stringify({
          ...
          state: data.state,
          mailingAddress: "From NEMT Landing Page",
          city: "TBD",
          zipCode: "00000",
          additionalInfo: `Vehicle Count: ${data.vehicleCount} - NEMT Insurance Lead`,
        }),
      });
        ...
        <div className="flex-1 bg-gradient-to-br from-primary via-primary/90 to-primary flex items-center justify-center p-4">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              A confirmation email has been sent to your inbox. Our NEMT insurance specialist will contact you within 24 hours with your personalized quote.
            </p>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Seo 
        ...
        description="Specialized insurance for wheelchair vans, ambulettes, and medical transport. Medicaid compliant coverage. Get your free NEMT insurance quote today!"
      />
      <Header />
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-white/80 mb-6">
                Specialized coverage for Non-Emergency Medical Transportation providers. Protect your patients and your business.
              </p>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  "Ambulette Insurance",
                  "Medicaid & Medicare Compliant",
                  "Professional Liability Included",
                  "SAM Coverage Available",
                ].map((feature, i) => (
              ...
              <div className="mt-8 bg-white/10 backdrop-blur rounded-xl p-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="font-semibold">Med Pay / PIP</p>
                    <p className="text-white/80">$5K - $25K</p>
                  </div>
                  <div>
                    <p className="font-semibold">UM/UIM Coverage</p>
                    <p className="text-white/80">State Minimums+</p>
                  </div>
                </div>
              </div>
              ...
              <div className="hidden lg:block">
                <img 
                  src={heroImage} 
                  alt="NEMT wheelchair accessible van" 
