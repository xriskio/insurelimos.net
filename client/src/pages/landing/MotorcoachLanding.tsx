...
import { Shield, CheckCircle, Phone, Clock, Award, Bus } from "lucide-react";
import { motion } from "framer-motion";
import heroImage from "@assets/generated_images/luxury_charter_motorcoach_bus.png";
...
const VEHICLE_COUNTS = [
  { value: "1", label: "1 Bus" },
  { value: "2-5", label: "2-5 Buses" },
  { value: "6-10", label: "6-10 Buses" },
  { value: "11-25", label: "11-25 Buses" },
  { value: "26+", label: "26+ Buses" },
];
...
export default function MotorcoachLanding() {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
      const response = await fetch("/api/quotes/transport", {
        ...
        body: JSON.stringify({
          quoteType: "motorcoach",
          insuredName: data.businessName,
          contactName: data.contactName,
          contactEmail: data.email,
          contactPhone: data.phone,
          state: data.state,
          mailingAddress: "From Motorcoach Landing Page",
          city: "TBD",
          zipCode: "00000",
          additionalInfo: `Vehicle Count: ${data.vehicleCount} - Motorcoach Insurance Lead`,
        }),
      });
  ...
  if (submitted) {
    return (
      <div className="min-h-screen flex flex-col">
        <Header />
        <div className="flex-1 bg-gradient-to-br from-primary via-primary/90 to-primary flex items-center justify-center p-4">
          <motion.div 
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              A confirmation email has been sent to your inbox. Our motorcoach insurance specialist will contact you within 24 hours with your personalized quote.
            </p>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Seo 
        title="Motorcoach Insurance - Charter Bus & Tour Bus Coverage"
        description="Specialized insurance for charter buses, tour buses, and motorcoach operators. DOT compliant coverage. Get your free motorcoach insurance quote today!"
      />
      <Header />
      
      <main className="flex-1 bg-gradient-to-br from-primary via-primary/90 to-primary">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-white/80 mb-6">
                Comprehensive coverage for charter buses, tour buses, and motorcoach operations. DOT compliant policies available.
              </p>
              
              <div className="space-y-4 mb-8">
                {[
                  "Charter Bus Coverage",
                  "Tour Bus Insurance",
                  "DOT Compliance Filing",
              ...
              <div className="mt-8 bg-white/10 backdrop-blur rounded-xl p-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-white/80">$1.5M - $5M CSL</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <p className="font-semibold">DOT Filings</p>
                    <p className="text-white/80">MCS-90 Included</p>
                  </div>
                  <div>
                    <p className="font-semibold">Passenger Coverage</p>
                    <p className="text-white/80">Up to 57 Passengers</p>
                  </div>
                </div>
              </div>
              ...
              <div className="hidden lg:block">
                <img 
                  src={heroImage} 
                  alt="Luxury charter motorcoach bus" 
