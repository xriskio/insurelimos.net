...
export default function SchoolBusLanding() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-500 via-orange-400 to-yellow-500 flex items-center justify-center p-4">
        <motion.div 
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            Thank you! Our school bus insurance specialist will contact you within 24 hours with your personalized quote.
          </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-500 via-orange-400 to-yellow-500">
      <Seo 
