...
const VEHICLE_COUNTS = [
  { value: "1-5", label: "1-5 Buses" },
  { value: "6-10", label: "6-10 Buses" },
  { value: "11-25", label: "11-25 Buses" },
  { value: "26-50", label: "26-50 Buses" },
  { value: "50+", label: "50+ Buses" },
];
...
export default function SchoolBusLanding() {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
      const response = await fetch("/api/quotes/transport", {
        ...
        body: JSON.stringify({
          quoteType: "school-bus",
          insuredName: data.businessName,
          contactName: data.contactName,
          contactEmail: data.email,
          contactPhone: data.phone,
          state: data.state,
          mailingAddress: "From School Bus Landing Page",
          city: "TBD",
          zipCode: "00000",
          additionalInfo: `Vehicle Count: ${data.vehicleCount} - School Bus Insurance Lead`,
        }),
      });
  ...
  if (submitted) {
    return (
      <div className="min-h-screen flex flex-col">
        <Header />
        <div className="flex-1 bg-gradient-to-br from-orange-500 via-orange-400 to-yellow-500 flex items-center justify-center p-4">
          <motion.div 
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              A confirmation email has been sent to your inbox. Our school bus insurance specialist will contact you within 24 hours with your personalized quote.
            </p>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Seo 
        title="School Bus Insurance - Coverage for Student Transportation"
        description="Specialized insurance for school bus contractors and student transportation providers. Comprehensive coverage for your fleet. Get your free quote today!"
      />
      <Header />
      
      <main className="flex-1 bg-gradient-to-br from-orange-500 via-orange-400 to-yellow-500">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-white/90 mb-6">
                Comprehensive coverage for school bus contractors and student transportation services. Protect your students and your business.
              </p>
              
              <div className="space-y-4 mb-8">
                {[
                  "School Bus Fleet Coverage",
                  "Student Transportation Liability",
                  "Physical Damage Protection",
                  "Workers Compensation Options",
                  "Contractor & District Programs",
                ].map((feature, i) => (
