              ...
              <section className="py-8 bg-secondary/20 rounded-lg mb-8">
                <div className="px-6">
                  ...
                  <Accordion type="single" collapsible className="space-y-4">
                    {nemtFaqs.map((faq, i) => (
                      <AccordionItem key={i} value={`faq-${i}`} className="border rounded-lg px-6 bg-white">
        ...
        <section className="py-20 bg-accent text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto mb-8">
              Get specialized coverage designed for the unique needs of NEMT and Paratransit operators.
            </p>
